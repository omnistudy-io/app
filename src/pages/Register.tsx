...
export default function Register() {
    ...
    const [showFirstNameText, setShowFirstNameText] = useState(true);
    // Email form value handling
    const [lastName, setLastName] = useState("");
    const [showLastNameText, setShowLastNameText] = useState(true);
    ...
    const [showUsernameText, setShowUsernameText] = useState(true);
    ...
    const [showConfirmPasswordText, setShowConfirmPasswordText] = useState(true);
    ...
    return (
        <div className="h-full px-6 py-24 bg-slate-100">
            <div className="flex flex-col h-full items-center justify-center lg:justify-between gap-y-4">
                ...
                <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
                    ...
                    <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                        <h1 className="text-left mb-5 text-2xl font-bold text-stone-500">Register for an account</h1>
                        <form onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="relative mb-6" data-te-input-wrapper-init>
                                    <input
                                        ...
                                        onBlur={(e) => {
                                            setShowFirstNameText(firstName === "")
                                        }}
                                    />
                                    {firstName === "" || showFirstNameText ? <label
                                ...
                                <div className="relative mb-6" data-te-input-wrapper-init>
                                    <input
                                        ...
                                        onBlur={(e) => {
                                            setShowLastNameText(lastName === "")
                                        }}
                                    />
                                    {lastName === "" || showLastNameText ? <label
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                <input
                                    type="text"
                                    className={`${errorType === "email" ? "border-red-500" : ""} peer block min-h-[auto] w-full rounded border-2 border-stone-300 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-stone-400 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0`}
                                    id="exampleFormControlInput3"
                                    placeholder="Email address"
                                    onChange={(e) => setEmail(e.target.value)}
                                    onBlur={(e) => {
                                        setShowEmailText(email === "")
                                    }}
                                />
                                {email === "" || showEmailText ? <label
                                    htmlFor="exampleFormControlInput3"
                                    className={`${errorType === "email" ? "border-red-500" : ""} pointer-events-none bg-slate-100 border-t-2 border-stone-300 px-2 absolute text-slate-500 left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:border-slate-100 peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-stone-400 dark:peer-focus:text-primary`}
                                >
                                    Email address
                                </label> : null}
                                {/* Email error message */}
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                <input
                                    type="text"
                                    className={`${errorType === "username" ? "border-red-500" : ""} peer block min-h-[auto] w-full rounded border-2 border-stone-300 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-stone-400 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0`}
                                    id="exampleFormControlInput3"
                                    placeholder="Username"
                                    onChange={(e) => setUsername(e.target.value)}
                                    onBlur={(e) => {
                                        setShowUsernameText(username === "")
                                    }}
                                />
                                {username === "" || showUsernameText ? <label
                                    htmlFor="exampleFormControlInput3"
                                    className={`${errorType === "username" ? "border-red-500" : ""} pointer-events-none bg-slate-100 border-t-2 border-stone-300 px-2 absolute text-slate-500 left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:border-slate-100 peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-stone-400 dark:peer-focus:text-primary`}
                                >
                                    Username
                                </label> : null}
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                ...
                                />
                                {password === "" || showPasswordText ? <label
                                    htmlFor="exampleFormControlInput33"
                                    className="pointer-events-none bg-slate-100 border-t-2 border-stone-300 px-2 absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:border-slate-100 peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-stone-400 dark:peer-focus:text-primary"
                                >
                                    Password
                            ...
                            <div className="relative mb-6" data-te-input-wrapper-init>
                                <input
                                    ...
                                    onBlur={(e) => {
                                        setShowConfirmPasswordText(confirmPassword === "")
                                    }}
                                />
                                {confirmPassword === "" || showConfirmPasswordText ? <label
                                    htmlFor="exampleFormControlInput33"
                                    className="pointer-events-none bg-slate-100 border-t-2 border-stone-300 px-2 absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[1.15rem] peer-focus:border-slate-100 peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[1.15rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-stone-400 dark:peer-focus:text-primary"
                                >
                                    Confirm Password
                            ...
                            <div className="my-2 text-left">
                                <span className="text-stone-500">
                                    Already have an account? <a className="text-cyan-600" href={"/login"}>Login here</a>.
                                </span>
                            </div>
                        </form>
                    </div>
